...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Create New Group</h1>
        ...
        <form action="{{ route('groups.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <select name="privacy" required class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white">
                    <option value="public" {{ old('privacy') === 'public' ? 'selected' : '' }}>Public - Anyone can see and join</option>
            ...
            <div class="flex gap-4">
                ...
                <a href="{{ route('groups.index') }}" class="btn bg-gray-200 text-gray-800 px-8 py-3 rounded-lg hover:bg-gray-300 transition font-semibold dark:bg-gray-700 dark:text-gray-200">
                    Cancel
                </a>
            </div>
        </form>
